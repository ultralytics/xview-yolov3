...
Before training, targets are cleaned up, removing outliers via sigma-rejection and creating 30 new k-means anchors for `cfg/c60_a30symmetric.cfg` with the MATLAB file `utils/analysis.m`:
